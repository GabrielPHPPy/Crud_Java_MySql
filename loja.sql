...
--
-- Host: 127.0.0.1
-- Tempo de geração: 19-Ago-2021 às 22:31
...
(1, 'gabriel', '119887', 'gabrielA8', 'gabriel');
...
--
ALTER TABLE `ordem_servicos`
  ADD CONSTRAINT `ordem_servicos_ibfk_1` FOREIGN KEY (`idcli`) REFERENCES `clientes` (`idcli`);
COMMIT;
